...
class _PipelineRows(BatchedCalls):
    """The Pipeline board's JSON-RPC vocabulary over two rows, for the Product/Issue fixture."""
...
class _PipelineBoard(_PipelineRows):
    fail_comments = False
...
class ProductBoard(_PipelineBoard):
