...
# The same fallback as a shell expression, because the commands below are rendered into card
# comments and run by a head in its own shell rather than resolved here.
