...
a09_start = text.index("### A09. Stop cross-package imports of private normalizers — complexity 3")
a10_start = text.index("### A10. Rename/consolidate the two `HeadRun` concepts", a09_start)
a09 = """### A09. Stop cross-package imports of private normalizers — complexity 3 — partially completed
...
"""
text = text[:a09_start] + a09 + text[a10_start:]

phase2_start = text.index("### Phase 2 — collapse string/dict protocols")
phase3_start = text.index("### Phase 3 — dispatcher typing and package boundaries", phase2_start)
phase2 = """### Phase 2 — collapse string/dict protocols
...
"""
text = text[:phase2_start] + phase2 + text[phase3_start:]
