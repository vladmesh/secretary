...
# Sessions of the CODEX_HOME pipeline Codex heads run with. Overridable in tests for the same
# reason as CLAUDE_PROJECTS/HERMES_HOME; unset, the active home is resolved per scan, so the move to
# `<data_dir>/codex-home` is followed the scan after the login.
