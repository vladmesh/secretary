...
class TaskWriter:
    ...
    def verdict(
        ...
        *,
        ...
        """Record one reviewer verdict: its prose, and the structured header that states it.

        The header is not a summary of the body. It is the verdict's own machine-readable
        statement — which candidate over which base, and the ordered blockers a RED is owed — and
        it is validated before anything is written, so an unreadable header is a refused verdict
        rather than a published one nothing can consume.
        """
