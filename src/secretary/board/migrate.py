...
#: `0013_budget_candidates` is the head: PO sessions, turns and feed, the one record of /po
#: request ids, who closed a session and when, the card kinds with their review choice and
#: live-impact flag, the indexes the audit's narrowed reads are served by, and the budget pass's
#: candidate index.
EXPECTED_SCHEMA_REVISION = "0013_budget_candidates"
