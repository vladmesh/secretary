...
#: `0018_owner_events` is the head: PO sessions, turns and feed, the one record of /po
...
#: the PO-executed card kinds `decision` and `operation`, and the owner events behind the bell.
EXPECTED_SCHEMA_REVISION = "0018_owner_events"
