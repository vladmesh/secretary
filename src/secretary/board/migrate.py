...
#: `0017_po_card_kinds` is the head: PO sessions, turns and feed, the one record of /po
...
#: and the PO-executed card kinds `decision` and `operation`.
EXPECTED_SCHEMA_REVISION = "0017_po_card_kinds"
