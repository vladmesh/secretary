...
class HostError(Exception):
    ...
    the enumerated bring-up cause from `secretary.dispatch.launch`, when the raise site — and only the raise
    ...
    cause-to-class mapping live in `secretary.dispatch.launch.classify_bring_up_failure`, and a cause this
