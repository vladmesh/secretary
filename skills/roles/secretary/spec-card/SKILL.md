...
## Where the card goes after you file it

The columns are `Issues, Ready, In progress, Validate, Assessment, Blocked, Done`. You file into
...
rework or reslice. As PO you may move a card out of it in any direction; do not treat a card sitting
there as a stuck pipeline to poke, and do not read it as approval either.
