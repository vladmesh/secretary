...
class CommandHostRuntime:
    ...
    def _worker_task_doc(
        ...
        sections += [
            ...
            "",
            "    python3 -m secretary check broad --command '<this project's broad suite command>'",
            "",
            "It streams the combined output while the suite runs and returns the command's own exit",
            ...
            "`python3 -m secretary check show --command '<the same command>'` and quote its summary",
