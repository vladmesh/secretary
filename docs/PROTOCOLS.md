...
Текущее решение остаётся fallback'ом только для карточки, заклеймленной до того, как claim начал
писать головы, и для головы, пропавшей из `heads.yaml`: возобновлять там нечего.
