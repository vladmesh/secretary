...
durable delivery batch before it wakes or replaces an observer, and a later resume acknowledges only that
batch's fixed card-event high-water mark. `secretary status --json` exposes the
