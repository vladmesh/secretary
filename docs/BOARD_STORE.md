...
one statement. Callers on the dispatcher tick and the web request path use them; whole-history
readers remain only off those paths. The growth policy that rests on this is `docs/REQUESTS_GROWTH.md`.
