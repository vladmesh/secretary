...
| A14 | 🟡 Remove the giant `dispatcher.py` compatibility façade — **bootstrap #463; pause #464; gate #465; observer #466; production #467; shared state/model layer #468** | **4** |
| A15 | 🟡 Continue the flat-root-to-feature-package migration and split god modules — **commands #463; pause #464; gate #465; observer #466; production #467; state/types/worker-lifecycle #468** | **4** |
