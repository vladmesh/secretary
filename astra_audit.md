...
| A14 | 🟡 Remove the giant `dispatcher.py` compatibility façade — **bootstrap boundary landed in #463; pause domain moved in #464** | **4** |
| A15 | 🟡 Continue the flat-root-to-feature-package migration and split god modules — **`dispatcher_commands.py` moved in #463; pause modules moved in #464** | **4** |
